...
const FullNews = () => {
	...
	<p>Автор: username, 23 марта 2019, 22:41</p>
		...
		<Link to=''><img className="img-size2" src="images/fold1.jpg" alt=""/></Link>
        </div>
			<div className="text-window1">
				...
				<div className="img-window1">
				<Link to=''><img className="img-size2" src="images/fold2.gif" alt=""/></Link>
                </div>
				<div className="img-window1">
				<Link to=''><img className="img-size2" src="images/fold3.gif" alt=""/></Link>
                </div>
				<div className="img-window1">
				<Link to=''><img className="img-size2" src="images/fold4.gif" alt=""/></Link>
                </div>
		<div className="text-window1">
			...
			<p style="padding-top: 5px;">Напомним, сегодня у Galaxy Fold появился конкурент - <Link to=''>складной Mate X от Huawei.</Link></p>
		</div>
	<div className="text-window1">
